...
- [ ] **补齐入口与双语文案** — 创建完成页、任务菜单和指挥中心提供“立即训练 / 优化策略 / 连接 Agent”清晰层级。
...
- [ ] **建立双语 StrategyLab 页面** — 实现 guided/code 草稿、保存/冲突、未保存提醒和窄屏布局。
- [ ] **接入模拟、AI diff 与版本发布** — 显示验证/比赛状态、接受补丁、发布和历史版本恢复。
- [ ] **连接回放与全站入口** — 从回放、创建、Arena、指挥中心和任务菜单进入实验室。

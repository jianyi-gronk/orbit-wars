"""Pinned Orbit Wars rule kernel derived from Kaggle Environments.

Modified for this project on 2026-07-17: renderer, bundled agents, JSON loading,
and the Kaggle runtime dependency were removed. See ../PROVENANCE.md and NOTICE.
"""
